                                ...
                                <div class="card h-100 shadow-sm">
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <h6 class="card-title mb-1" style="font-size:.98rem;">
                                            <?php echo htmlspecialchars($p['product_name']); ?></h6>
                                        <p class="text-muted small mb-3">
                                            <?php echo htmlspecialchars($p['description']); ?></p>
                        ...
                        <div class="product-details-sidebar">
                            ...
                            <div class="product-info">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <button class="btn add-to-cart" style="background-color: #6b0f0f; color: white;">Add
                                        to Cart</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="cart-summary">
                                ...
                                <div class="d-flex gap-2">
                                    <button class="btn flex-grow-1"
                                        style="background-color: #6b0f0f; color: white;">Proceed to Checkout</button>
                                    <button class="btn" style="border-color: #6b0f0f; color: #6b0f0f;">Request for
                                        Quotation</button>
                                </div>
                            </div>
                        </div>
