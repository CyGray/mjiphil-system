                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars(substr($item['description'], 0, 30)) . (strlen($item['description']) > 30 ? '...' : ''); ?>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        <button class="btn-action" title="Edit Item"
                                            onclick="editItem(<?php echo $item['product_id']; ?>)">
                                            <i class="fas fa-pencil-alt"></i>
                                        </button>
                                        <button class="btn-action" title="Delete Item"
                                            onclick="deleteItem(<?php echo $item['product_id']; ?>)">
                    ...
                    <form method="POST" id="addItemForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="stock_quantity" placeholder="Quantity"
                                    min="0" required>
                            </div>
                        </div>
                            ...
                            <div class="file-upload-container">
                                <div class="file-upload-area" id="fileUploadArea">
                                    ...
                                    <input type="file" id="product_image" name="product_image"
                                        accept=".png,.jpg,.jpeg,.webp,.svg" style="display: none;">
                                </div>
                ...
                <div class="modal-body">
                    <form method="POST" id="editItemForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label class="form-label">Price</label>
                                <input type="number" class="form-control" name="price" id="edit_price" placeholder="0.00"
